...
class LearningAgent(Agent):
    ...
    def createQ(self, state):
        ...
        if self.learning:
            ...
            #print "cteate Q:{}".format(self.Q)
            print "cteate Q len:{}".format(len(self.Q))
        return
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
           if state not in self.Q:
              print "The state not found in the Q. Exiting the program abnormally from learn() function"
              print "exit state:{}".format(state)
              print "Q states:{}".format(self.Q)
              sys.exit()
           else:
        ...
        #print "rewards queue:{}".format(self.rewards_queue)
